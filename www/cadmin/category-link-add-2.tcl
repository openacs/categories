...
set page_title "Add link from \"$link_tree_name\" to category \"$tree(tree_name) :: $category_name\""
...
lappend context_bar [list [export_vars -no_empty -base tree-view {tree_id locale object_id}] $tree_name] \
