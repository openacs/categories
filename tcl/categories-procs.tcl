...
namespace eval category {
    ...
    ad_proc -public phase_in { category_id } {
    ...
    ad_proc -public get_mapped_categories { object_id } {
    ...
    ad_proc -public flush_translation_cache { category_id } {
	...
	@param category_id category of which to get the name.
    ...
    ad_proc -public get_object_context { object_id } {
    ...
    ad_proc repeat_string { string iteration_number } {
